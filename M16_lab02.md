...
+ <h4>h. Additional Issues</h4>
  - [Make the GUI look better](https://github.com/UCSB-CS56-Projects/cs56-utilities-cryptography/issues/32) 
    ...
    - Change the position where the app shows up from startup)  (250 pts)  
  - [Improve input textbox function](https://github.com/UCSB-CS56-Projects/cs56-utilities-cryptography/issues/33) 
    - make the textbox bigger so that it can take several paragraph of messages, and also make it scrollable) (200 pts) 
  - [Improve All-cipher function](https://github.com/UCSB-CS56-Projects/cs56-utilities-cryptography/issues/34) 
    - when click All-cipher, there can be a pop-up windows where you have eight input windows in which you put plaintexts and keys separately so that this makes more sense to the user. (250 pts) 
  - [Clipboard support & output cleanup](https://github.com/UCSB-CS56-Projects/cs56-utilities-cryptography/issues/35)
    - user can copy the output text by just clicking a button & also add a button to cleanup the output field (200pts)
